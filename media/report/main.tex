...
generated points connected using a cosine interpolation function. The choice of
these datasets were intended to each test the model with a varying degree of
stochasticity, the sin waves being the most deterministic, or predictable, the
random points being the most stochastic, or random, and the stock price data
hopefully being somewhere in between.
...
\begin{figure}[H]
	...
	\caption{LSTM Training Loss on GeneratedSins, GeneratedNoise, and Stocks Datasets for Models with Varying Number of Cell Layers}
...
\begin{figure}[H]
	...
	\caption{LSTM Test Loss over Predicted Sequence Steps for GeneratedSins, GeneratedNoise, and Stocks Datasets for Models with Varying Number of Cell Layers}
...
This dataset proved, as it reasonably should, to be the most predictable of the
three datasets. This can be observed in the plot of training losses in Figure
...
of a 2-layer LSTM model trained on this dataset with the ground truth
sequence underlaid.  
