...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width=0.95\textwidth]{figures/rnn_arch.png}
	\end{center}
...
distribution as $x$. In short, discriminative models look at many Van Gogh
paintings and fakes in order to learn to differentiate between them, and
generative models look at many Van Gogh paintings in order to learn how to
paint like Van Gogh.
