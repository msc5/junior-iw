...
plotted within the range $(0, 1)$. In sum, the train split consists of FILLIN
batches, and the test set consists of FILLIN batches.
...
split consists of FILLIN batches, and the test set consists of FILLIN batches.
...
datasets. The train split consists of FILLIN batches, and the test set consists
of FILLIN batches.
